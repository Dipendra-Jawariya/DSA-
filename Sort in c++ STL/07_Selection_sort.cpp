// Selection sort is one of the basic algorithm
// THEta(N^2) selection sort will always take this time complexity even we gave it sorted array
// Does less memory writes compared to quickSort, merfe sort,Insertion sort, etc. But cycle sort is optimal in terms of memort writes.
// Basic idea for heapsort
// noy stable
// in-plce .

// Basic idea for Selection Sort is we find out hte minimu element and place it to the first index and so on
